...
/**
 * XmlApi_ParseData_PatientDeleteShippingAddress
 */
class XmlApi_ParseData_PatientDeleteShippingAddress extends Utility_ParseDataBase
{
	/**
	 * Constructor
	 *
	 * @param mixed $xml_content
	 * @return XmlApi_ParseData_PatientDeleteShippingAddress
	 */
